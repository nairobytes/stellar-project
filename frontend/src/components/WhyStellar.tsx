    ...
    <section className="border-y theme-border theme-accent-wash py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="landing-hover-block">
            <p className="landing-shift section-label mb-4">Why Stellar</p>
            <h2 className="landing-shift font-serif text-3xl font-semibold theme-heading md:text-4xl">
              Enterprise finance,
              <span className="text-accent block landing-shift">without enterprise friction.</span>
            </h2>
          ...
          <div className="landing-table-wrap overflow-hidden border theme-border theme-surface shadow-sm">
            <table className="w-full text-sm">
              ...
              <tbody>
                {rows.map((row) => (
                  <tr key={row.metric} className="table-row landing-table-row">
                    <td className="landing-shift py-4 px-4 font-medium theme-heading">{row.metric}</td>
                    <td className="landing-shift py-4 px-4 font-semibold text-accent">{row.stellar}</td>
                    <td className="landing-shift py-4 px-4 text-subtle">{row.traditional}</td>
                  </tr>
                ))}
              </tbody>
            </table>
